<?php
/**
 * Template Name: Cosmética Template
 */
?>
<?php get_header(); ?>
        <div class="wrapcenter">
                ...
                <div class="menu_1">
                    <ul>
                        ...
                        <li ><a href="<?php echo get_page_link(151); ?>" ><h2 class="seo">SEMILLAS AUTOMÁTICAS</h2></a></li>
                        ...
                        <li ><a href="<?php echo get_page_link(75); ?>"><h2 class="seo">COSMÉTICA</h2></a></li>
                    </ul>
                </div>
            </div>
                ...
                <aside class="cat">
                    <nav class="cat_1">
                        <ul id="cat-nav">
                            ...
                            <li><a href="vestuario.php"><h2 class="seo">&#43;&nbsp;VESTUARIO Y ACCESORIOS</h2></a></li>
                            <li class="li_cos"><a href="<?php echo get_page_link(75); ?>"><h2 class="seo">&#43;&nbsp;COSMÉTICA</h2></a></li>
                        </ul>
                    </nav>
                </aside>
            </div>
...
<?php query_posts('category_name=cosmetica'); ?>
